...
// import phoneAuthComponent from './PhoneAuth';
import HomeComponent from './Home';
...
export default App = () => {
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        {
          isAuth.pending ? <Stack.Screen name="loading" component={LoadingComponent}/> : 
          !isAuth ? <Stack.Screen name="phoneAuth" component={PhoneAuthComponent}/> : 
          registeredUser.pending ? <Stack.Screen name="loading" component={LoadingComponent}/> : 
          !registeredUser ? <Stack.Screen name="registration" component={RegistrationComponent}/> :
